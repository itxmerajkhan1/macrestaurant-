      ...
      <div className="max-w-7xl mx-auto w-full space-y-24">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-4">
              <h2 className="text-6xl md:text-8xl font-black tracking-tighter leading-none neon-gold uppercase">QUALITY <br /> STORY</h2>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="px-8 py-4 btn-neon-red flex items-center gap-2">
                OUR SOURCES <Globe className="w-5 h-5" />
              </button>
              <button className="px-8 py-4 glass text-white font-bold rounded-xl hover:border-[#FFC72C]/50 transition-all flex items-center gap-2">
              ...
              <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-4 w-full px-8">
                {metrics.slice(0, 2).map((m, i) => (
                  <div key={i} className="flex-1 glass p-4 rounded-2xl border-l-2 border-l-[#FFC72C]">
                    ...
                    <p className="text-lg font-black neon-gold">{m.value}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-black tracking-tight">SUSTAINABLE SECTORS</h3>
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-black tracking-tight">NEURAL-PURE BEEF</h3>
            <p className="text-sm text-white/40 leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-black tracking-tight">FLAVOR ARCHITECTURE</h3>
            <p className="text-sm text-white/40 leading-relaxed">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {metrics.map((m, i) => (
            <div key={i} className="glass p-8 rounded-3xl border-l-2 border-l-[#FFC72C] group hover:border-white/20 transition-all">
              ...
              <p className="text-3xl font-black tracking-tighter group-hover:neon-gold transition-colors">{m.value}</p>
            </div>
          ))}
        </div>
        ...
        <div className="glass p-12 rounded-3xl text-center space-y-8 relative overflow-hidden">
          ...
          <div className="relative space-y-4">
            <h3 className="text-4xl font-black tracking-tight uppercase">READY TO EXPERIENCE THE QUALITY?</h3>
          ...
          <button className="relative px-12 py-5 btn-neon-red text-lg uppercase tracking-widest">
            ORDER NOW
          </button>
        </div>
      </div>
